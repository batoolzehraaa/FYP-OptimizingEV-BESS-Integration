...
discharging_power = 30;  % kW (initial)
...
loadProfile = [0.8, 0.9, 1.0, 1.1, 1.3, 1.5, 1.8, 2.0, 2.3, 2.4, 2.5, 2.7, ...
               2.9, 3.0, 2.8, 2.1, 2.2, 2.0, 2.0, 1.5, 1.7, 1.6, 0.5, 1.1, 1.0];
...
while simTime < endTime
    ...
    if SOC_value < target_SOC_max
        ...
        P_BESS =- charging_power*load_scaling_factor;  % Set dynamic charging power
    ...
    elseif SOC_value > target_SOC_min
        ...
        P_BESS = discharging_power*load_scaling_factor;  % Set dynamic discharging power
        DSSText.Command = ['Storage.BESS1.KW=', num2str(P_BESS)];
