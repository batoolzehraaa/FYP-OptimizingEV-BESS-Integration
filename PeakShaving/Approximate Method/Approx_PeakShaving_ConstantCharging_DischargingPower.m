...
% load profiles for summer and winter
...
total_charging_energy_month=total_charging_energy*30*6;  % Total Charging Energy 
total_discharging_energy_month=total_discharging_energy*30*6;  % Total Discharging Energy
total_charging_cost=total_charging_energy_month*unit_price;  % Total cost in PKR
total_discharging_cost=total_discharging_energy_month*unit_price;  % Total cost in PKR
